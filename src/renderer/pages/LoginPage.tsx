 ...
 * Contains branding, login buttons, and features
 */
    ...
    <div className="start-page-content">
      ...
      <div className="start-actions">
        {isLoading ? (
          ...
          <>
            ...
            <button className="start-btn primary" onClick={handleContinue}>
              Get Started
            </button>
          </>
        ) : (
          <>
            ...
            <button className="start-btn primary" onClick={handleLogin}>
              Sign in to Agentage
            </button>
            <button className="start-btn skip" onClick={handleContinue}>
      ...
      <div className="start-info">
        <div className="start-features">
          ...
          <div className="feature">
            <svg className="feature-icon feature-icon--run" fill="currentColor" viewBox="0 0 24 24">
